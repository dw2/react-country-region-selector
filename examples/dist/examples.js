...
var CountryDropdown = (function (_React$Component) {
  ...
  _createClass(CountryDropdown, [{
    ...
    value: function render() {
      ...
      var rest = _objectWithoutProperties(_props3, ['name', 'id', 'classes', 'value', 'onChange', 'onBlur', 'disabled']);
      ...
      return _react2['default'].createElement('select', _extends({}, rest, attrs), this.getDefaultOption(), this.getCountries());
    }
  }]);
...
var RegionDropdown = (function (_React$Component2) {
  ...
  _createClass(RegionDropdown, [{
    ...
    value: function render() {
      ...
      var rest = _objectWithoutProperties(_props6, ['value', 'country', 'onChange', 'onBlur', 'id', 'name', 'classes', 'disabled', 'disableWhenEmpty']);
      ...
      return _react2['default'].createElement('select', _extends({}, rest, attrs), this.getDefaultOption(), this.getRegionList());
    }
  }]);
...
},{"./source-data.js":3,"prop-types":9,"react":undefined}],3:[function(require,module,exports){
"use strict";
...
},{"./checkPropTypes":6,"./lib/ReactPropTypesSecret":10,"_process":5,"object-assign":4}],9:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
